...
انا *⚡ 𝐍𝐨𝐞𝐥 𝐒𝐚𝐦𝐚 ⚡*, 
تم تطويري بواسطة *🕊️ 𝐝𝐚𝐛𝐢 🕊️*.

*الاوامر الخاصة بي 🤍🌫️*:  ${prefix}
...
⋄═──═◞🍁 قائمة التحويل 🍁◟━──━⋄
 ...
 ❏ .نسبه-حبك
 ❏ البوت يجيب لك نسبه حب الشخص ليك
...
case '':
 ...
 const needhelpmenu = `مرحبا بك في بوتة نويل سليفا لظهور قائمه الاوامر اكتب .الاوامر او اضغط علي القائمه لا تنسي وضع *${prefix} قبل كل امر🕊❤*`
...
const txt = `🕊🤍 مرحــبـا بـك عـزيـزي انــــا مـتـصـل الـان🤍🕊،


'🕊🤍كـيــف يـمـكـنـنـي مـسـاعـدتـك🕊🤍،


'🕊🤍شـكـرا لــك لـاسـتـخـدامـك🕊🤍،
'⚡𝐁𝐨𝐭 - 𝐍𝐨𝐞𝐥 𝐒𝐚𝐦𝐚 ⚡`
const mikuarray= [
